...
function workbench_prepare_input_file_Disc(discobj)

    % Edits the support files, taken from the templates folder for a resonator of type Disc or CantileverFiber, 
